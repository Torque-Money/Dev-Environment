...
import type { Margin, MarginInterface } from "../Margin";
...
export class Margin__factory {
  static readonly abi = _abi;
  static createInterface(): MarginInterface {
    return new utils.Interface(_abi) as MarginInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Margin {
    return new Contract(address, _abi, signerOrProvider) as Margin;
  }
}
