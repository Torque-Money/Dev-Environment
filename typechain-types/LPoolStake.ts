...
export interface LPoolStakeInterface extends utils.Interface {
  contractName: "LPoolStake";
  functions: {
    ...
    "redeemValue(address,uint256)": FunctionFragment;
    ...
    "stakeValue(address,uint256)": FunctionFragment;
...
export interface LPoolStake extends BaseContract {
  contractName: "LPoolStake";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LPoolStakeInterface;
