...
interface IOracle {
    ...
    /**
     *  @notice returns the interest accumulated as a percent of a given borrowed asset for a given timeframe
     *  @param _token address
     *  @param _timeframe uint256
     *  @return _interest uint256
     */
    function calculateInterest(address _token, uint256 _timeframe) external view returns (uint256 _interest);
}