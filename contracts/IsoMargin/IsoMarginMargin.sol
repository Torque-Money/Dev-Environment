...
abstract contract IsoMarginMargin is IsoMarginAccount {
    ...
    function marginLevel(IERC20 collateral_, IERC20 borrowed_, address account_) public view returns (uint256, uint256) {
    ...
    function underCollateralized(IERC20 collateral_, IERC20 borrowed_, address account_) public view returns (bool) {
        (uint256 marginNumerator, uint256 marginDenominator) = marginLevel(collateral_, borrowed_, account_);
